...
class Trainer:
    ...
    def train_epoch(self, train_loader):
        ...
        for batch in train_loader:
            ...
            scores = self.model(drug_ids, disease_ids)
    ...
    def train(self, train_loader, val_loader, fold_i):
        ...
        l_reports = [("epoch", "train_loss", "val_auc", "val_aupr", "val_accuracy", "val_precision", "val_recall", "val_f1", "val_mcc")]
        ...
        for epoch in range(self.epochs):
            ...
            l_reports.append(current_result)
            
            if self.best_metric == "Mix":
